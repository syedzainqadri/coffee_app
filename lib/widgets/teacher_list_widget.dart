...
class TeachersListWidget extends StatefulWidget {
  ...
  @override
  State<TeachersListWidget> createState() => _TeachersListWidgetState();
}

class _TeachersListWidgetState extends State<TeachersListWidget> {
              ...
              children: [
                SizedBox(
                  ...
                  child: PageView.builder(
                      ...
                      itemCount: TeacherItem.mockItems.length,
                      scrollBehavior: WindowsScrollBehaviour(),
                      scrollDirection: Axis.horizontal,
                      itemBuilder: (context, index) {
                        final TeacherItem item = TeacherItem.mockItems[index];
